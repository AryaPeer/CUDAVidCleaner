...
/**
 * VideoProcessor class to handle the entire video processing pipeline
 */
class VideoProcessor {
public:
    /**
     * Constructor for video processor
     ...
     * @param forceCPU Force CPU-based video processing even if CUDA is available
     */
    VideoProcessor(float lowCutoff, float highCutoff, float noiseReduction, float videoDenoiseStrength, bool forceCPU = false);
...
private:
    ...
    // Video denoiser (can be CPU or CUDA based)
