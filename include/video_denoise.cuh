...
/**
 * Class for CUDA-accelerated video denoising
 */
class CUDAVideoDenoiser : public VideoDenoiser {
public:
    /**
     * Constructor for CUDAVideoDenoiser
    ...
    /**
     * Denoise a frame using CUDA
     * @param inputFrame Input frame (CPU memory)
     * @return Denoised frame (CPU memory)
     */
