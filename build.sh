...
# Project root directory (assuming the script is in the root)
PROJECT_ROOT=$(pwd)
SRC_DIR="$PROJECT_ROOT/src"
BUILD_DIR="$PROJECT_ROOT/build_bash" # New directory for bash build

# Compiler and C++ standard
CXX=g++
CXX_STANDARD="-std=c++17"

# Source files for cuda_video_cleaner (CPU version)
...
APP_EXECUTABLE="$BUILD_DIR/cuda_video_cleaner"
...
INCLUDE_PATHS="-Iinclude" # New way, assuming script is run from project root

# --- Build cuda_video_cleaner ---
echo "Building cuda_video_cleaner..."
APP_OBJECTS=""
...
echo "cuda_video_cleaner built successfully: $APP_EXECUTABLE"
